...
class FoodTruckTest < Minitest::Test
  ...
  def test_it_returns_inventory
    food_truck = FoodTruck.new("Rocky Mountain Pies")
    assert_equal ({}), food_truck.inventory
  end

  def test_it_checks_stock_n_inventory
  ...
  def test_it_reduces_quantity
    ...
    food_truck3.sell(item1, 45)
    assert_equal 20, food_truck3.check_stock(item1)
  end
